...
Open `Enodia.xcodeproj`, select your development team, then update the signing requirements in `Enodia/Info.plist` and `EnodiaHelper/Info.plist` to match your Apple Development certificate and Team ID. Build and run the `Enodia` scheme.
